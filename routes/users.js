...
router.get('/profile', async (req, res) => {
    if (req.session.AuthCookie === undefined) {
        ...
        try {
            ...
            console.log('logged in user type:', userdetails.userType);
            ...
            res.render("users/profile", { userData: allData, isDisplayLogout: true, badges  : badge, isAdmin : (userdetails.userType == "admin")});
        } catch (e) {
